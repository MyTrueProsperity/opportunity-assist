...
Follow-up: incorporated the other task's `5904ac3` scanner migration before implementing the new worker. The next live observation found 4,377 rows, maximum ID 4,887, latest insertion 2026-09-08 21:16:13 UTC. These figures do not prove lists 1–6 are fully loaded; the input table remains intact and later inserts are reconciled by the new daily job.
