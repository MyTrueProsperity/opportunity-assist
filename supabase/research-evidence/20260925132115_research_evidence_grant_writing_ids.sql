-- Accept GW-nnn record IDs for the grant-writing research volume
-- (GRANT_WRITING_APPROVAL_RESEARCH_V1_2026-09-24) without replacing any other
-- installed volume namespace. Same narrow pattern as the earlier ID migrations.
...
begin
  ...
  if position('^GW-' in previous_expression) = 0 then
